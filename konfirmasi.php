...
$sql = "SELECT * FROM pesanan WHERE id_pesanan = $id_pesanan AND id_user = {$_SESSION['user_id']}";
...
<head>
    <title>BeyourselF Product | Konfirmasi Pesanan</title>
</head>
...
<body>
    ...
    <?php if ($pesanan['metode_pembayaran'] == 'transfer_bank'): ?>
        <div style="border: 1px solid #ccc; padding: 15px; margin-top: 20px;">
            ...
            <p>Transfer ke: BANK ABC (1234567890)</p>

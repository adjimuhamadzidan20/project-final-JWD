...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE produk SET nama_produk = '$nama_produk', kategori_produk = '$kategori_produk', gambar = '$gambar', 
    harga = '$harga', deskripsi = '$deskripsi', stok = '$stok' WHERE id_produk = $id_produk";

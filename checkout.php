...
$sqlUser = "SELECT produk.*, keranjang.jumlah FROM keranjang JOIN produk 
ON keranjang.id_produk = produk.id_produk WHERE keranjang.id_user = {$_SESSION['user_id']}";
$cart_query = mysqli_query($conn, $sqlUser);
...
<head>
    <title>BeyourselF Product | Checkout</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <!-- Form Checkout -->
        <form action="config_process/proses_checkout.php" method="POST" enctype="multipart/form-data">
            <!-- Data Pengiriman -->
            ...
            <div class="opsi-konfirmasi">
                <a href="index.php?page=keranjang" class="btn-kembali">Kembali</a>
